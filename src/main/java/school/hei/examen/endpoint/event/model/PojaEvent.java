...
import static school.hei.examen.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.examen.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "school.hei.examen.event1";
  }
}
